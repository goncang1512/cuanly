    ...
    <div>
      ...
      >
        <DrawerContent
          ...
          buttonClose={false}
          className="data-[vaul-drawer-direction=bottom]:max-h-full h-full data-[vaul-drawer-direction=bottom]:rounded-none data-[vaul-drawer-direction=bottom]:border-0 mx:px-0 px-3"
        >
